...
#line 86 "/euijun-casl/accel-sim/accel-sim-framework/gpu-simulator/gpgpu-sim/build/gcc-11.4.0/cuda-12040/release/intersim2/y.tab.c"
...
#line 1075 "/euijun-casl/accel-sim/accel-sim-framework/gpu-simulator/gpgpu-sim/build/gcc-11.4.0/cuda-12040/release/intersim2/y.tab.c"
    break;

  case 5: /* command: STR '=' NUM ';'  */
#line 33 "config.y"
                            { config_assign_int( (yyvsp[-3].name), (yyvsp[-1].num) ); free( (yyvsp[-3].name) ); }
#line 1081 "/euijun-casl/accel-sim/accel-sim-framework/gpu-simulator/gpgpu-sim/build/gcc-11.4.0/cuda-12040/release/intersim2/y.tab.c"
    break;

  case 6: /* command: STR '=' FNUM ';'  */
#line 34 "config.y"
                            { config_assign_float( (yyvsp[-3].name), (yyvsp[-1].fnum) ); free( (yyvsp[-3].name) ); }
#line 1087 "/euijun-casl/accel-sim/accel-sim-framework/gpu-simulator/gpgpu-sim/build/gcc-11.4.0/cuda-12040/release/intersim2/y.tab.c"
    break;


#line 1091 "/euijun-casl/accel-sim/accel-sim-framework/gpu-simulator/gpgpu-sim/build/gcc-11.4.0/cuda-12040/release/intersim2/y.tab.c"
